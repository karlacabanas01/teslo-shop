...
export const getServerSideProps: GetServerSideProps = async ({ params }) => {
    ...
    if ( query.length === 0 ) { //Si el query no existe
        return {
            redirect: {
                destination: '/',
                permanent: true
    ...
    // y no hay productos
    let products = await dbProducts.getProductsByTerm( query ); //Mando el query de busqueda y me devuelve un array de productos
