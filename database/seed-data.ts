...
export const initialData: SeedData = {
    users:[
        {
            name:'Karla',
            email:'karla@kranio.io',
            password: bcrypt.hashSync('asdfg123') , //Contraseña encriptada, un hash es imporisble de recuperar
            role: 'admin'
        },{
            name:'javier',
            email:'javier@kranio.io',
            password: bcrypt.hashSync('asdfg123') ,
            role: 'client'
        },
    ],
    products: [
